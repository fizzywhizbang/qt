...
import (
	...
	"github.com/fizzywhizbang/qt/internal/binding/templater"

	"github.com/fizzywhizbang/qt/internal/cmd"
	"github.com/fizzywhizbang/qt/internal/cmd/deploy"
	"github.com/fizzywhizbang/qt/internal/cmd/minimal"
	"github.com/fizzywhizbang/qt/internal/cmd/moc"
	"github.com/fizzywhizbang/qt/internal/cmd/rcc"
...
func Test(target string, docker, vagrant bool, vagrantsystem string) {
	...
	for cat, list := range examples {
		for _, example := range list {
			...
			path := filepath.Join(strings.TrimSpace(utils.GoListOptional("{{.Dir}}", "github.com/fizzywhizbang/qt/internal/examples", "-find", "get doc dir")), example)
