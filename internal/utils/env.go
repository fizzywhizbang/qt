...
func GoList(args ...string) *exec.Cmd {
	...
	if UseGOMOD("") {
		if !(strings.Contains(strings.Join(args, "|"), "github.com/fizzywhizbang/qt/internal") && !strings.Contains(strings.Join(args, "|"), "github.com/fizzywhizbang/qt/internal/binding/runtime")) {
